...
#define PATCH_NUM_VELOCITY_OFFSET_VALS  100
#define PATCH_NUM_VELOCITY_DEPTH_VALS   100
...
#define PATCH_NUM_LFO_SENSITIVITY_VALS  100

#define PATCH_NUM_TRANSPOSE_VALS 25 /* -12 to 12 */
...
enum
{
  ...
  PATCH_PARAM_LINE_1_VIBRATO_ENABLE, 
  PATCH_PARAM_LINE_1_TREMOLO_ENABLE, 
  /* line 2 */
  ...
  PATCH_PARAM_LINE_2_VIBRATO_ENABLE, 
  PATCH_PARAM_LINE_2_TREMOLO_ENABLE, 
  /* output */
  ...
  /* velocity */
  PATCH_PARAM_VELOCITY_OFFSET, 
  PATCH_PARAM_VELOCITY_DEPTH, 
  /* vibrato */
